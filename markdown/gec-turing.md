...
![#acessibilidade: A imagem é de uma máquina de escrever acinzentada colocada sobre um chão de madeira.](https://pt.wikipedia.org/wiki/Ficheiro:Olivetti_Lettera_22_by_LjL.jpeg) 
...
image6 - A máquina de Turing: das máquinas de escrever aos computadores (V.8, N.6, P.4, 2025)
Figura 1 – Abstração
...
image5 - A máquina de Turing: das máquinas de escrever aos computadores (V.8, N.6, P.4, 2025)
Figura 2 – O funcionamento da máquina simplificada
...
image2 - A máquina de Turing: das máquinas de escrever aos computadores (V.8, N.6, P.4, 2025)
Figura 3 – O modelo em ação
...
image1 - A máquina de Turing: das máquinas de escrever aos computadores (V.8, N.6, P.4, 2025)
Figura 4 – O problema do 0
...
image3 - A máquina de Turing: das máquinas de escrever aos computadores (V.8, N.6, P.4, 2025)
Figura 5 – s de solução, s de separador
